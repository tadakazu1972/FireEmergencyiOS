...
class TyphoonSelectDialog2: NSObject, UITableViewDelegate, UITableViewDataSource {
    ...
    init(index: Int, parentView: TyphoonViewController){
        ...
        switch index {
        case 1:
            items = ["■氾濫注意水位(水位4.5m)、水防警報(出動)", "■高齢者等避難が発令される見込みとなった場合\n　急激な水位上昇時の対応になる場合", "■【警戒レベル３】高齢者等避難(水位5.4m)", "■【警戒レベル４】避難指示(水位5.5m)", "■【警戒レベル５】緊急安全確保(水位8.34m)"] //淀川（枚方）
            break
        case 2:
            items = ["■氾濫注意水位(水位3.2m)、水防警報(出動)", "■高齢者等避難が発令される見込みとなった場合\n　急激な水位上昇時の対応になる場合", "■【警戒レベル３】高齢者等避難(水位4.96m)", "■【警戒レベル４】避難指示(水位5.54m)", "■【警戒レベル５】緊急安全確保(水位6.19m)"] //大和川（柏原）
            break
        case 3:
            items = ["■氾濫注意水位(水位3.8m)、水防警報(出動)", "■高齢者等避難が発令される見込みとなった場合", "■【警戒レベル３】高齢者等避難(水位4.82m)", "■【警戒レベル４】避難指示(水位5.03m)", "■【警戒レベル５】緊急安全確保(水位5.82m)"] //神崎川（三国）
            break
        case 12:
            items = ["■氾濫注意水位(水位2m)、水防警報(出動)", "■高齢者等避難が発令される見込みとなった場合", "■【警戒レベル３】高齢者等避難(水位2.2m)", "■【警戒レベル４】避難指示(水位2.3m)", "■【警戒レベル５】緊急安全確保(水位3.21m)"] //天竺川 2020.06 追加
        break
        case 13:
            items = ["■氾濫注意水位(水位1.5m)、水防警報(出動)", "■高齢者等避難が発令される見込みとなった場合", "■【警戒レベル３】高齢者等避難(水位1.62m)", "■【警戒レベル４】避難指示(水位1.7m)", "■【警戒レベル５】緊急安全確保(水位3.66m)"] //高川 2020.06追加, 2021.05改正
        break
        case 4:
            items = ["■氾濫注意水位(水位3.25m)、水防警報(出動)", "■高齢者等避難が発令される見込みとなった場合", "■【警戒レベル３】高齢者等避難(水位3.54m)", "■【警戒レベル４】避難指示(水位4.25m)", "■【警戒レベル５】緊急安全確保(水位5.13m)"] //安威川（千歳橋）
            break
        case 5:
            items = ["■氾濫注意水位(水位3m)、水防警報(出動)", "■高齢者等避難が発令される見込みとなった場合", "■【警戒レベル３】高齢者等避難(水位3.14m)", "■【警戒レベル４】避難指示(水位3.32m)", "■【警戒レベル５】緊急安全確保(水位3.5m)"] //寝屋川（京橋）
            break
        case 6:
            items = ["■氾濫注意水位(水位3.4m)、水防警報(出動)", "■高齢者等避難が発令される見込みとなった場合", "■【警戒レベル３】高齢者等避難(水位4.25m)", "■【警戒レベル４】避難指示(水位4.55m)", "■【警戒レベル５】緊急安全確保(水位4.85m)"] //第二寝屋川（昭明橋）
            break
        //平野川
        case 7:
            items = ["■氾濫注意水位(水位3.3m)、水防警報(出動)", "■高齢者等避難が発令される見込みとなった場合", "■【警戒レベル３】高齢者等避難(水位3.92m)", "■【警戒レベル４】避難指示(水位4.16m)", "■【警戒レベル５】緊急安全確保(水位4.4m)"] //平野川（剣橋）
            break
        //第２平野川
        case 8:
            items = ["■氾濫注意水位(水位3.3m)、水防警報(出動)", "■高齢者等避難が発令される見込みとなった場合", "■【警戒レベル３】高齢者等避難(水位3.4m)", "■【警戒レベル４】避難指示(水位3.85m)", "■【警戒レベル５】緊急安全確保(水位4.63m)"] //平野川分水路（今里大橋）
            break
        case 9:
            items = ["■氾濫注意水位(水位3.2m)、水防警報(出動)", "■高齢者等避難が発令される見込みとなった場合", "■【警戒レベル３】高齢者等避難(水位3.3m)", "■【警戒レベル４】避難指示(水位3.4m)", "■【警戒レベル５】緊急安全確保(水位3.67m)"] //古川（桑才）2020.06修正
            break
        case 10:
            items = ["■氾濫注意水位(水位2.9m)、水防警報(出動)", "■高齢者等避難が発令される見込みとなった場合", "■【警戒レベル３】高齢者等避難(水位3.2m)", "■【警戒レベル４】避難指示(水位3.9m)", "■【警戒レベル５】緊急安全確保(水位5.29m)"] //東除川（大堀上小橋）
            break
        case 15:
            items = ["【警戒レベル５】緊急安全確保（参考水位5.88m)\n※石川が上記水位に到達している場合は、東除川の水位を確認してください。"] //石川（玉手橋） 2021.05追加
        case 14:
            items = ["■氾濫注意水位(水位2.5m)、水防警報(出動)", "■高齢者等避難が発令される見込みとなった場合", "■【警戒レベル３】高齢者等避難(水位3.7m)", "■【警戒レベル４】避難指示(水位4m)", "■【警戒レベル５】緊急安全確保(水位5.06m)"] //西除川 2020.06 追加
        break
        case 16:
            items = ["■高齢者等避難が発令される見込みとなった場合", "■【警戒レベル３】高齢者等避難(水位3.32m)", "■【警戒レベル４】避難指示(水位3.5m)", "■【警戒レベル５】緊急安全確保(水位3.9m)"] //旧淀川流域等の河川 2022.05 追加
        break
        case 11:
            items = ["■高潮区域(水防警報(出動))", "■高齢者等避難が発令される見込みとなった場合", "■【警戒レベル３】高齢者等避難", "■【警戒レベル４】避難指示", "■【警戒レベル５】緊急安全確保"] //高潮 2020.09 名称を高潮のみに変更
            break
        default:
            items = [""]
            break
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 14:
            ...
            break
        //旧淀川流域等の河川(京橋) 2022.05　追加(既存分を修正しないためcase 16とする)
        case 16:
            switch indexPath.row {
            //氾濫注意水位の設定がないため、showResutの引数は162からとなる
            case 0:
                mTyphoonResultDialog2 = TyphoonResultDialog2(index:mIndex, parentView: parent)
                mTyphoonResultDialog2.showResult(162)
                break
            case 1:
                mTyphoonResultDialog2 = TyphoonResultDialog2(index:mIndex, parentView: parent)
                mTyphoonResultDialog2.showResult(163)
                break
            case 2:
                mTyphoonResultDialog2 = TyphoonResultDialog2(index:mIndex, parentView: parent)
                mTyphoonResultDialog2.showResult(164)
                break
            case 3:
                mTyphoonResultDialog2 = TyphoonResultDialog2(index:mIndex, parentView: parent)
                mTyphoonResultDialog2.showResult(165)
                break
            default:
                break
            }
